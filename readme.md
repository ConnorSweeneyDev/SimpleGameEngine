...
Building and running will use only files from MinGW and the project directory.
...
Building and running will use files from the project directory but also all over the usr directory.
