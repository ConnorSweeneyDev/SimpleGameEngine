...
CC := gcc
ifeq ($(DEBUG), 1)
  CXX_FLAGS := -g -O2 -MD -MP -std=c++17 -D_GLIBCXX_DEBUG -D_GLIBCXX_DEBUG_PEDANTIC -D_FORTIFY_SOURCE=2 -fstack-protector-strong
  CC_FLAGS := -g -O2 -MD -MP -D_GLIBCXX_DEBUG -D_GLIBCXX_DEBUG_PEDANTIC -D_FORTIFY_SOURCE=2 -fstack-protector-strong
else
